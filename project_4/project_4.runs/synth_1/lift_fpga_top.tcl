...
synth_design -top lift_fpga_top -part xc7a35tcpg236-1
...
write_checkpoint -force -noxdef lift_fpga_top.dcp
OPTRACE "write_checkpoint" END { }
OPTRACE "synth reports" START { REPORT }
generate_parallel_reports -reports { "report_utilization -file lift_fpga_top_utilization_synth.rpt -pb lift_fpga_top_utilization_synth.pb"  } 
