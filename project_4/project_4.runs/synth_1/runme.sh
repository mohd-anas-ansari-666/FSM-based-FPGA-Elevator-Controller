...
HD_PWD='C:/Users/HP/Desktop/MajorProject/V2/Elevator Controller/project_4/project_4.runs/synth_1'
cd "$HD_PWD"
...
EAStep vivado -log lift_fpga_top.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source lift_fpga_top.tcl
