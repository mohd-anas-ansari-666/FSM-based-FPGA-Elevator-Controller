...
HD_PWD='C:/Users/HP/Desktop/MajorProject/V2/Elevator Controller/project_4/project_4.runs/impl_1'
cd "$HD_PWD"
...
EAStep vivado -log lift_fpga_top.vdi -applog -m64 -product Vivado -messageDb vivado.pb -mode batch -source lift_fpga_top.tcl -notrace
