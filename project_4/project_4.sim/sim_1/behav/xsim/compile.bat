...
REM
REM Generated by Vivado on Mon May 11 17:21:07 +0530 2026
...
echo "xvlog --incr --relax -prj lift_fpga_top_vlog.prj"
call xvlog  --incr --relax -prj lift_fpga_top_vlog.prj -log xvlog.log
